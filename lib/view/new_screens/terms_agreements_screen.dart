...
class TermsAgreementsScreen extends StatefulWidget {
  const TermsAgreementsScreen({Key? key}) : super(key: key);
                  ...
                  children: [
                    ...
                    Container(
                        ...
                        Align(
                            ...
                            child: HeaderText(text: MyStrings.termsAgreements.tr,textAlign: TextAlign.center,textStyle: const TextStyle(
                              fontSize: 30.0,
                              fontFamily: 'American',
                            ),))
                    ),
