...
class _MenuScreenState extends State<MenuScreen> {
  ...
  void initState() {
    ...
    final controller = Get.put(CustomMenuController(repo: Get.find()));
                        ...
                        children: [
                          Container(
                              ...
                              Align(
                                  ...
                                  child: HeaderText(text:  MyStrings.menu.tr,textAlign: TextAlign.center,textStyle: const TextStyle(
                                    fontSize: 30.0,
                                    fontFamily: 'American',
                                  ),))
                          ),
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(color: MyColor.getCardColor(), borderRadius: BorderRadius.circular(15)),
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                DefaultText(text: MyStrings.setting, textStyle: interRegularDefault.copyWith(color: MyColor.colorBlack)),
                          ...
                          Container(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                DefaultText(text: "${MyStrings.helpAndSetting.tr}", textStyle: interRegularDefault.copyWith(color: MyColor.colorBlack)),
                                const SizedBox(height: Dimensions.space15),
