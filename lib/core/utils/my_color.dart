...
class MyColor{
 ...
 // static const Color primaryColor = Color(0xffCBA352);
  static const Color primaryColor = Color(0xff1E3882);

  static const Color backgroundColor =  Color(0xFF4285F4);
  static const Color buttonColor =  Color(0xFF32CCFE);
/*
...
*/
  ...
  /// bottom navbar
  static const Color bottomNavBgColor = Color(0xff006A91);
  static const Color borderColor =Color(0xff2C3F47);

  static const Color gradientStartColor =Color(0xff1E3882);
  static const Color gradientEndColor =Color(0xff278BC7);
...
/*  static const Color lScreenBgColor1 = Color(0xfff5f6fa);
  ...
  */
  static const Color lScreenBgColor1 = Color(0xFF4285F4);
  static const Color lScreenBgColor = Color(0xffE7E9EA);
  static const Color lTextColor = Color(0xff2A3962);
  static const Color lPrimaryColor = Color(0xff1F2B3A);
  static const Color lCardBgColor = Color(0xff006A91);
  ...
  static Color getCardColor(){
    return Get.find<ThemeController>().darkTheme ? lCardBgColor.withOpacity(0.7) : colorBlack;
  }
  ...
  static Color getFieldDisableBorderColor(){
   // return Get.find<ThemeController>().darkTheme ? fieldDisableBorderColor : colorGrey.withOpacity(0.3);
    return Get.find<ThemeController>().darkTheme ? Colors.white : colorGrey.withOpacity(0.3);
  }

  static Color getFieldEnableBorderColor(){
   // return Get.find<ThemeController>().darkTheme ? primaryColor : lPrimaryColor;
    return Get.find<ThemeController>().darkTheme ? Colors.white : lPrimaryColor;
  }
  ...
  static Color getBottomNavColor(){
    return Get.find<ThemeController>().darkTheme ? bottomNavBgColor.withOpacity(0.8) : colorWhite;
  }
